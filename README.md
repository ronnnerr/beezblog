...
A portable Beeezo blog index and long-form reader built from the company's public **Smarter Marketing Solutions** newsletter editions. All article copy, cover artwork, fonts, and the official wordmark are stored locally so the page does not depend on LinkedIn at runtime.

## What ships

- Nine real Beeezo newsletter editions.
...
3. Keep imported inline links restricted to explicit HTTP(S) destinations.
4. Add the original publication URL to `docs/content-sources.md` for provenance.
...
The Beeezo trademarks and newsletter artwork in this repository are client assets, not generic open-source project assets. Confirm Beeezo's publication approval before redistributing the repository publicly.
